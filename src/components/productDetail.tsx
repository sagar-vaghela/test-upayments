...
const ProductDetail = () => {
  const { id } = useParams();
  const product = useSelector<initialStateType, productType>(
    (state) => state.productData.product
  );
    ...
    <div className="flex justify-center">
      <div className="box-border ">
        <div className="flex justify-center right-2.5">
          ...
          <div>
            <div className="text-4xl font-bold mt-48 mr-64">
              {product?.name}
            </div>
        ...
        <div className="justify-center">
          ...
          <div className="text-2xl font-Zinc-400 mt-4 text-Blacks">
            Description
          </div>
